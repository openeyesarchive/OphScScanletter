...
/**
 * This is the model class for table "et_ophscscanletter_document".
 *
...
class Element_OphScScanletter_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscscanletter_document';
	}
